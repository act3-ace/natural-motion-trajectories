...
from controllers.linear_control_to_NMT import Controller
...
srange = 4000 # [m]
vrange = 3    # [m/s]
x0 = np.array([[srange*2*(np.random.rand()-0.5)],  # x
               [srange*2*(np.random.rand()-0.5)],  # y 
               [0],  # z
...
if f_plot_option == 0 : 
    ...
    ax2.plot([0,10000], [0, 10000*2*mean_motion], 'r--' )
    ax2.plot([0,10000], [0, 10000*0.5*mean_motion], 'r--' )
